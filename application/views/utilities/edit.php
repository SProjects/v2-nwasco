<div class="wrapper wrapper-content">
    <div class="row wrapper border-bottom white-bg page-heading crumbs">Edit/Update Commercial Utility</div>
    <div id="mycontent">
        <div class="row">
            <div class="col-centered col-lg-6">
                <div class="ibox float-e-margins white-bg">
                    <form id="update_utility" class="form-horizontal" method="post">
                        <div class="col-lg-12">
...
<script>
    $(document).ready(function () {
        $("#update_utility").submit(function (e) {
            e.preventDefault();
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url() ?>utility/update/',
                dataType: 'text',
                data: $("#update_utility").serialize(),
                timeout: 5000,
                success: function () {

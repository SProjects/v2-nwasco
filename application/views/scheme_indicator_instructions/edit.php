<div class="wrapper wrapper-content">
    <div class="row wrapper border-bottom white-bg page-heading crumbs">
        <?= $scheme->getName(); ?> <i class="fa fa-chevron-right"></i> Edit/Update <?= $indicator->getName(); ?>
    </div>
    <div id="mycontent">
                                        ...
                                        <div class='col-md-6'>
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date">
                                                    ...
                                                    <input type="date" class="form-control"
                                                           name="created_at"
                                                           placeholder="Enter date of issue" value="<?= $existing_instructions[0]->getCreatedAt(); ?>"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    $(document).ready(function () {
        $("#update_instruction").submit(function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?= base_url() ?>scheme_indicator_instructions/update/',
                dataType: 'text',
                ...
                success: function () {
                    ...
                    window.location.href = "<?= base_url().'scheme/show/'.$scheme->getId(); ?>";
                },
                error: function () {

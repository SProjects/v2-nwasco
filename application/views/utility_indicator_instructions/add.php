<div class="wrapper wrapper-content">
    <div class="row wrapper border-bottom white-bg page-heading crumbs">
        <?= $utility->getName(); ?> <i class="fa fa-chevron-right"></i> Add <?= $indicator->getName(); ?>
    </div>
    <div id="mycontent">
                                                ...
                                                <div class='row'>
                                                    <div class='col-md-12'>
                                                        <div class="form-group">
                                                            <label class="font-noraml required required"><?= $indicator_property->getName(); ?></label>
                                        ...
                                        <?php case 'DATE': ?>
                                            <div class="col-lg-12">
                                                <div class='row'>
                                                    <div class='col-md-6'>
                                                        <div class="form-group">
                                                            <label class="font-noraml required"><?= $indicator_property->getName(); ?></label>

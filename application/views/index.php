        ...
        ?>
                            ...
                            <li class="col-lg-1 summary">
                              ...
                              <ul class="dropdown-menu">
                                <div>
                                  <span>Inspection Directives</span><div class="stat-percent font-bold text-danger"><?=$dquery0;?></div>
                                  <div class="clearfix"></div>
                                  <span>Tariff Conditions</span><div class="stat-percent font-bold text-danger"><?=$tquery0;?></div>
                                  <div class="clearfix"></div>
                                  <span>Projects</span><div class="stat-percent font-bold text-danger"><?=$pquery0;?></div>
                                  <div class="clearfix"></div>
               ...
               echo base_url(); ?>utility/details/<?php echo $utility->cu_id;?>/<?php echo urlencode(strtolower($url));?>">
                              ...
                              <a class="dropdown-toggle" data-toggle="dropdown"><?=$neardue;?></a>
                                 <ul class="dropdown-menu">
                                <div>
                                  <span>Inspection Directives</span><div class="stat-percent font-bold text-warning"><?=$dquery5;?></div>
                                  <div class="clearfix"></div>
                                  <span>Tariff Conditions</span><div class="stat-percent font-bold text-warning"><?=$tquery5;?></div>
                                  <div class="clearfix"></div>
                                  <span>Projects</span><div class="stat-percent font-bold text-warning"><?=$pquery5;?></div>
                                  <div class="clearfix"></div>
               ...
               echo base_url(); ?>utility/details/<?php echo $utility->cu_id;?>/<?php echo urlencode(strtolower($url));?>">
                              ...
                              <a class="dropdown-toggle" data-toggle="dropdown"><?=$active;?></a>
                                 <ul class="dropdown-menu">
                                <div>
                                  <span>Inspection Directives</span><div class="stat-percent font-bold text-navy"><?=$dquery6;?></div>
                                  <div class="clearfix"></div>
                                  <span>Tariff Conditions</span><div class="stat-percent font-bold text-navy"><?=$tquery6;?></div>
                                  <div class="clearfix"></div>
                                  <span>Projects</span><div class="stat-percent font-bold text-navy"><?=$pquery6;?></div>
                                  <div class="clearfix"></div>

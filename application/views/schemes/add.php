<div class="wrapper wrapper-content">
    <div class="row wrapper border-bottom white-bg page-heading crumbs">Add New Private Scheme</div>
    <div id="mycontent">
        <div class="row">
            <div class="col-centered col-lg-6">
                <div class="ibox float-e-margins white-bg">
                    <form id="add_new_scheme" class="form-horizontal" method="post">
                        <div class="col-lg-12">
...
<script>
    $(document).ready(function () {
        $("#add_new_scheme").submit(function (e) {
            e.preventDefault();

			...
			<form id="directive_update" class="form-horizontal" method="post">
				...
				<input type="hidden" name="dir_id" value="<?=$directive->dir_id; ?>">
										...
										<div class='col-md-6'>
				                            <div class="form-group" id="data_1">
				                                ...
				                                <div class="input-group date">
				                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" class="form-control" name="issue_date" value="<?=date('Y-m-d', strtotime($directive->issue_date)); ?>">
				                                </div>
				                            </div>
										    </div>
										    <div class='col-md-6'>
					                            <div class="form-group" id="data_2">
					                                ...
					                                <div class="input-group date">
					                                 <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" class="form-control" name="due_date" value="<?=date('Y-m-d', strtotime($directive->due_date)); ?>">
					                                </div>
					                            </div>
										    </div>
									</div>
                                ...
                                <div class="form-group">
	                                <input type="hidden" name="directive" class="form-control" value="<?=$directive->dir_id; ?>">
									<div class="ibox-content no-padding">
                        			<textarea name="directive" class="summernote">
		                                <?=$directive->directive; ?>
		                            </textarea>
		                            <label class="">Add Comments</label>
		                            <textarea name="comment" class="form-control" placeholder="Write comment here..."><?=$directive->comments; ?></textarea>
								<a href="#" type="button" class="btn btn-sm btn-info pull-left col-sm-2"><i class="fa fa-caret-left"></i> Go Back</a>
<div class="col-lg-7">
...
<div id="response" class="alert-success" style="text-align:center;"></div>
								...
								<button class="btn btn-primary btn-sm pull-right col-sm-3" id="button" name="submit" type="submit"><i class="fa fa-save"></i> Save changes</button>
		                        </div>
                                    </div>
                                </div>
                            </form>

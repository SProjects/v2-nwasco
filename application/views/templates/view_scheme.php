<?php $psid = $this->uri->segment(3); ?>
<?php
    $query = $this->db->get_where('private_schemes', array('ps_id' => $psid));
    $row = $query->row();
    $ps_id = $row->ps_id;
?>
<?php
...
<div class="wrapper wrapper-content">
    <div class="row wrapper border-bottom white-bg page-heading crumbs">Private Scheme <i
        ...
        <div class="row utility">
            <div class="col-lg-12 no-gutter">
                ...
                <?php if (count($sindicators) > 0)
                    if (isset($sindicators) && $sindicators) : $i = 0;
                        foreach ($sindicators as $sindicator) : $sin_id = $sindicator->sin_id; ?>
                            <div class="col-md-4">
            ...
            <div class="col-lg-12">
                <div class="tabs-container">
                    <ul class="nav nav-tabs">
                        <?php if (isset($sindicators) && $sindicators) : $i = 0;
                            foreach ($sindicators as $sindicator) : ?>
                                <li class="tab<?php if ($i === 0): ?> active<?php endif; ?>">
                                    <a data-toggle="tab"
                                       href="#tab-<?= $sindicator->sin_id; ?>"><?= $sindicator->fname; ?></a>
                                </li>
                                <?php $i++; endforeach; endif; ?>

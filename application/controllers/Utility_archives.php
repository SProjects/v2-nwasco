...
class Utility_archives extends CI_Controller {
    public $utilitydao;
    public $schemedao;
    public $indicatordao;
...
EOF;
    ...
    public function show($id) {
        if ($this->ion_auth->logged_in()) {
            ...
            $data['instructions'] = Utility_model::getIndicatorInstructions($utility, TRUE);

            $this->load->view('header', $data);
            $this->load->view('utility_archives/show', $data);

...
class Scheme_archives extends CI_Controller {
    public $utilitydao;
    public $schemedao;
    public $indicatordao;
...
EOF;
    ...
    public function show($id) {
        if ($this->ion_auth->logged_in()) {
            ...
            $data['scheme'] = $scheme;
            $data['instructions'] = Scheme_model::getIndicatorInstructions($scheme, TRUE);

            $this->load->view('header', $data);
            $this->load->view('scheme_archives/show', $data);

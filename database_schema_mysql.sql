...
--
-- Host: localhost:3306
-- Generation Time: Sep 11, 2016 at 07:07 AM
...
--
-- Table structure for table `private_schemes`
--

CREATE TABLE IF NOT EXISTS `private_schemes` (
...
--
-- Dumping data for table `private_schemes`
--

INSERT INTO `private_schemes` (`ps_id`, `scheme`) VALUES
(1, 'Zesco Limited'),
(2, 'Zambia Sugar pls'),
(3, 'Lafarge cement plc'),
(4, 'Maamba Collieries Limited'),
(5, 'Konkola Copper Mines plc'),
(6, 'Kaleya Smallholders'),
(7, 'Kafue Sugar');
...
--
-- Table structure for table `scheme_indicators`
--

CREATE TABLE IF NOT EXISTS `scheme_indicators` (
  `sin_id` double DEFAULT NULL,
  `fname` varchar(255) DEFAULT NULL,
  `sname` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `scheme_indicators`
--

INSERT INTO `scheme_indicators` (`sin_id`, `fname`, `sname`) VALUES
(1, 'Directives', 'Directives'),
(2, 'Operating Licence', 'OL'),
(3, 'Service Level Guarantees and Agreements ', 'SLAs/ SLGs');

-- --------------------------------------------------------

--
-- Table structure for table `sdirectives`
--

CREATE TABLE IF NOT EXISTS `sdirectives` (
  `sd_id` double DEFAULT NULL,
  `directive` mediumtext,
  `issue_date` datetime DEFAULT NULL,
  `due_date` datetime DEFAULT NULL,
  `status` varchar(255) DEFAULT NULL,
  `comments` varchar(255) DEFAULT NULL,
  `dircat_id` double DEFAULT NULL,
  `ps_id` double DEFAULT NULL,
  `sin_id` double DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `sdirectives`
--

INSERT INTO `sdirectives` (`sd_id`, `directive`, `issue_date`, `due_date`, `status`, `comments`, `dircat_id`, `ps_id`, `sin_id`) VALUES
(1, 'Submit a report by 29th May 2015, specifying what measures you will undertake to improve the system for new connections.  ', '2015-05-05 00:00:00', '2015-05-29 00:00:00', NULL, NULL, 1, 2, 1),
(2, 'Immediately discontinue the misapplication of the approved ‘new connections charge’ to would-be customers in all districts and submit the list of affected customers indicating their respective charges to NWASCO by 29th May 2015 after refunding all customers who paid wrong connection fees. ', '2015-05-06 00:00:00', '2015-05-29 00:00:00', NULL, NULL, 1, 2, 1),
(3, 'Submit a time bound report by the 29th May 2015, which indicates how you intend to ensure that all operators in charge of water quality monitoring are retrained to enhance their skills on standard testing procedures. ', '2015-05-07 00:00:00', '2015-05-29 00:00:00', NULL, NULL, 1, 2, 1),
(4, 'Arising from the issues of concern, you are further directed to submit a time bound report to NWASCO showing how the company proposes to take corrective measures by 29th May 2015.', '2015-05-08 00:00:00', '2015-05-29 00:00:00', NULL, NULL, 1, 2, 1),
(5, 'Provide a time-bound plan of how you intend to improve service hours to Service Level Guarantee by 14th November 2014. ', '2014-06-10 00:00:00', '2014-11-14 00:00:00', NULL, NULL, 1, 10, 1),
(6, 'Provide a plan of remedial measures to the areas of concern by 14th November 2014.', '2014-06-10 00:00:00', '2014-11-14 00:00:00', NULL, NULL, 1, 10, 1),
(7, 'Devise and implement strategies to address the billing challenges particularly those that were as a result of human error and submit a report to NWASCO.', '2014-06-25 00:00:00', '2014-10-30 00:00:00', NULL, NULL, 1, 3, 1),
(8, 'Ensure the Maintenace Management System (MMS) is implemented in all the districts.', '2014-06-25 00:00:00', '2014-10-30 00:00:00', NULL, NULL, 1, 3, 1),
(9, 'Install wash outs in the distribution systems in all districts particularly the phase one districts of KFW funded projects.', '2014-06-25 00:00:00', '2014-10-30 00:00:00', NULL, NULL, 1, 3, 1),
(10, 'Ensure that all pending billing and sewer bloackage complaints are resolved within the stipulated timeframe in your SLG.', '2014-06-25 00:00:00', '2014-10-30 00:00:00', NULL, NULL, 1, 3, 1),
(11, 'Immediately stop selective reporting of water quality results and ensure that all tests conducted by districts are included in quarterly water quality reports submitted to NWASCO, particularly in the Northern Regional Office. Such ill reporting will attract a penalty on your overall 2014 water quality results.', '2015-06-27 00:00:00', NULL, NULL, NULL, 1, 9, 1),
(12, 'Immediately start using the 2010 ZABS Standards on Drinking Water Quality of 5 NTU for turbidity in the Northern Region and not the limit of 10 NTU.', '2015-06-27 00:00:00', '2015-01-27 00:00:00', NULL, NULL, 1, 9, 1),
(13, 'Immediately put in place remedial measures to stabilise pH for the water supplied in Zimba district. ', '2015-06-27 00:00:00', '2015-01-27 00:00:00', NULL, NULL, 1, 9, 1),
(14, '4.    Conduct an assessment of the viability of kiosks and ensure that all those that were inactive were decommissioned particularly the 38 that were noted in Livingstone to avoid double counting when assessing water service coverage.', '2015-06-27 00:00:00', '2015-02-27 00:00:00', NULL, NULL, 1, 9, 1),
(15, 'Immediately start expensing the 40% vendor commission from the kiosks’ collections and include it in the total collections for the company.', '2015-06-27 00:00:00', '2015-01-27 00:00:00', NULL, NULL, 1, 9, 1),
(16, 'Address rampant sewage overflows in Livingstone.', '2015-06-27 00:00:00', '2015-02-27 00:00:00', NULL, NULL, 1, 9, 1),
(17, 'Ensure that you reconcile the ring-fenced meter charge funds (Maamba collections) and the expected funds to be ring-fenced and therefore deposit the difference in the ring-fenced account.', '2015-06-27 00:00:00', '2015-02-27 00:00:00', NULL, NULL, 1, 9, 1),
(18, 'Ensure that all the districts / centres keep records for collections, banking and water quality test results in the company’s prescribed format.', '2015-06-27 00:00:00', '2015-02-27 00:00:00', NULL, NULL, 1, 9, 1),
(19, 'Adhere to HR policies and normalise accrual of leave days.', '2015-06-27 00:00:00', '2015-02-27 00:00:00', NULL, NULL, 1, 9, 1),
(20, 'Immediately ensure all customers who have applied for new connections and have fully paid up are connected in accordance with the Minimum Service Level Guidelines. Further, in view of the fact that this is not the first time you are running out of meters to enable you make new connections, submit a report to NWASCO on how you will prevent this from reoccurring by 26th September 2014. ', '2014-05-09 00:00:00', NULL, NULL, NULL, 1, 11, 1),
(21, 'Submit to NWASCO your raw water quality results data for tests conducted in the second quarter 2014 for Solwezi.', '2014-05-09 00:00:00', NULL, NULL, NULL, 1, 11, 1),
(22, 'Give reasons why punitive action should not be taken against you for supplying water below the service level guarantees in Cheshire Homes, Magrade Extension, and Airport Zambia Compounds all of Solwezi District. ', '2014-05-09 00:00:00', NULL, NULL, NULL, 1, 11, 1),
(23, 'Ensure that applicable tariffs are printed on all kiosks by 3rd October 2014.', '2014-05-10 00:00:00', '2014-03-10 00:00:00', NULL, NULL, 1, 11, 1),
(24, 'Compensate all the affected customers in Zambezi who were wrongly charged K5.00 as new connection application fees from the effective date of the applicable tariffs.  ', '2014-05-11 00:00:00', '2014-09-26 00:00:00', NULL, NULL, 1, 11, 1),
(25, 'Further, the utility was directed to attend to the following areas of concern and avail report by 26th September 2014.', '2014-05-12 00:00:00', '2015-09-26 00:00:00', NULL, NULL, 1, 11, 1),
(26, 'Provide a plan of remedial measures to be undertaken to address the highlighted issues of concern. ', '2014-05-05 00:00:00', '2015-05-30 00:00:00', NULL, NULL, 1, 7, 1),
(27, 'There were unacceptable lapses in the process of connecting new customers and capturing them in the billing system, leading to loss of revenue. Some accounts took as long as six months from time of connecting to capturing into the billing system.', '2014-05-05 00:00:00', '2015-05-30 00:00:00', NULL, 'Issue will be revisited for verification during inspections in May 2015.  ', 1, 7, 1),
(28, 'Little effort had been made to curb the excessive number of casual employees which account for as high as 28% of your wage bill. This was evident by continuous renewal of contracts without detailed assessments of labour requirements. Samples showed that some contracts were even renewed verbally.', '2014-05-05 00:00:00', '2015-05-30 00:00:00', NULL, 'All casuals have now signed contracts and are being gradually laid off if supervisors don’t justify their requirement.  Issue will be assessed further during inspections in May 2015.', 1, 7, 1),
(29, 'There was an apparent slow response to address numerous leaks observed on water lines, particularly in Ndola City. ', '2014-05-05 00:00:00', '2015-05-30 00:00:00', NULL, 'Bursts are being attended to as they arise. However, most distribution lines are earmarked for replacement during the recently commenced DANIDA funded projects.  ', 1, 7, 1),
(30, 'Immediately investigate by-passes and/or illegal connections in all districts and devise measures to curb them. Additionally, carryout a database cleanup and submit a report of the above activities by 31st October 2014.', '2014-06-25 00:00:00', '2014-10-31 00:00:00', NULL, NULL, 1, 1, 1),
(31, 'Devise a strategy to reactivate disconnected customers. A report of the measures taken should be submitted to NWASCO by 30th September 2014.', '2014-06-25 00:00:00', '2014-09-30 00:00:00', NULL, NULL, 1, 1, 1),
(32, 'Avail NWASCO a report on corrective actions taken or that you will undertake on the following issues of non-compliance and concerns.', '2014-06-16 00:00:00', '2015-01-30 00:00:00', NULL, NULL, 1, 5, 1);

-- --------------------------------------------------------

--
-- Table structure for table `solicence`
--

CREATE TABLE IF NOT EXISTS `solicence` (
  `opl_id` double DEFAULT NULL,
...
--
-- Dumping data for table `solicence`
--

INSERT INTO `solicence` (`opl_id`, `licence`, `due_date`, `status`, `remarks`, `ps_id`, `sin_id`) VALUES
(1, 'Ensure that actual costs do not exceed an adverse variance of 10% of the approved cost structure for 2014.', '2014-02-14 00:00:00', NULL, NULL, 1, 2),
(2, 'Maintain an average collection efficiency of at least 85% throughout the tariff period', '2014-08-31 00:00:00', NULL, NULL, 1, 2),
(3, 'Maintain a full  cost coverage rate of at least 90%  at 85% collection efficiency throughout the tariff period', '2014-02-14 00:00:00', NULL, NULL, 1, 2),
(4, 'Reactivate 900 customer accounts by 31st August 2014', '2014-08-31 00:00:00', NULL, NULL, 1, 2),
(5, 'Increase number of connections by at least 500 by 30th August 2014', '2014-08-30 00:00:00', NULL, NULL, 2, 2),
(6, 'Improve metering to at least 85% by 31st August 2013', '2014-08-31 00:00:00', NULL, NULL, 2, 2),
(7, 'Maintain water quality compliance above 95% throughout the tariff period.', '2014-02-14 00:00:00', NULL, NULL, 2, 2),
(8, 'Remain current on NWASCO license fees throughout 2014 and propose a payment plan on how your licence fee arrears will be cleared within the tariff period.', '2014-08-31 00:00:00', NULL, NULL, 3, 2),
(9, 'Ring fence the fixed meter charge throughout the tariff period', '2014-02-14 00:00:00', NULL, NULL, 3, 2),
(10, 'Fully meet the  2014 Service level agreement', '2014-08-31 00:00:00', NULL, NULL, 3, 2),
(11, 'Ensure that external auditing of Financial Statements is up to date.', '2014-08-30 00:00:00', NULL, NULL, 4, 2),
(12, 'Ensure that no meter remains stuck for longer than 3 months', '2014-08-31 00:00:00', NULL, NULL, 5, 2),
(13, 'Submit an energy consumption reduction strategy by 14th February 2014 2014 and report on implementation biannually within the tariff period.', '2014-02-14 00:00:00', NULL, NULL, 4, 2),
(14, 'Ensure that actual costs do not exceed an adverse variance of 10% of the approved cost structure of  K22,548,540 for 2015', '2014-08-31 00:00:00', NULL, NULL, 4, 2),
(15, 'Achieve an average collection efficiency of at least 85% by 31st August 2015', '2014-02-14 00:00:00', NULL, NULL, 4, 2),
(16, 'Achieve O&M cost coverage rate of at least 68% at 85% collection efficiency by 31st August 2015', '2014-08-31 00:00:00', NULL, NULL, 4, 2),
(17, 'Increase number of connections by  900 from the current 15,266  by 31st August 2015', '2014-08-30 00:00:00', NULL, NULL, 6, 2),
(18, 'Maintain 100% metering throughout the tariff period', '2014-08-31 00:00:00', NULL, NULL, 6, 2),
(19, 'Maintain water quality compliance above 95% throughout the tariff period', '2014-02-14 00:00:00', NULL, NULL, 6, 2),
(20, 'Remain current on NWASCO license fees throughout 2015 and propose a payment plan on how 40% of your licence fee arrears (base K275,860) will be cleared within the tariff period i.e. January to August 2015. ', '2014-08-31 00:00:00', NULL, NULL, 6, 2),
(21, 'Ring fence the fixed meter charge throughout the tariff period', '2014-02-14 00:00:00', NULL, NULL, 6, 2),
(22, 'Fully adhere to the  2015 Service Level Guarantees', '2014-08-31 00:00:00', NULL, NULL, 3, 2),
(23, 'Ensure that external auditing of Financial Statements is up to date', '2014-08-30 00:00:00', NULL, NULL, 3, 2),
(24, 'Ensure that no meter remains stuck for longer than 3 months', '2014-08-31 00:00:00', NULL, NULL, 3, 2),
(25, 'Submit a plan on how you intend to extend water supply service to the Mental Hospital in Chadiza and Airport  and Farmers training college in Mambwe by 28th February 2015', '2014-02-14 00:00:00', NULL, NULL, 3, 2),
(26, 'Submit a plan on how you intend to improve sewerage services in Kapata in Chipata by 28th February 2015', '2014-08-31 00:00:00', NULL, NULL, 3, 2),
(27, 'Submit an energy consumption reduction strategy by 31st January 2015 and report on implementation biannually within the tariff period', '2014-02-14 00:00:00', NULL, NULL, 3, 2),
(28, 'Ring fence 20% of the sewerage billing throughout the tariff period', '2014-08-31 00:00:00', NULL, NULL, 3, 2),
(29, 'Ensure that actual costs do not exceed an adverse variance of 10% of the approved cost structure (ZMW50, 750,739) for 2015.', '2014-08-30 00:00:00', NULL, NULL, 1, 2),
(30, 'Maintain an average collection efficiency of at least 85% throughout the tariff period', '2014-08-31 00:00:00', NULL, NULL, 1, 2),
(31, 'Achieve an O&M cost coverage rate of at least 116%  at 85% collection efficiency by August 2015', '2014-02-14 00:00:00', NULL, NULL, 1, 2),
(32, 'Increase total customer base by at least 2,400 connections by 31st August 2015 from the current 40,965 total connections.', '2014-08-31 00:00:00', NULL, NULL, 1, 2),
(33, 'Install 4,000 meters by 31st August 2015. ', '2014-02-14 00:00:00', NULL, NULL, 2, 2),
(34, 'Maintain water quality compliance above 95% throughout the tariff period.', '2014-08-31 00:00:00', NULL, NULL, 2, 2),
(35, 'Remain current on NWASCO license fees throughout 2015', '2014-08-30 00:00:00', NULL, NULL, 2, 2),
(36, 'Ring fence the fixed meter charge throughout the tariff period', '2014-08-31 00:00:00', NULL, NULL, 3, 2),
(37, 'Ring fence 20% of the sewerage billing throughout the tariff period', '2014-02-14 00:00:00', NULL, NULL, 3, 2),
(38, 'Ensure that external auditing of Financial Statements is up to date.', '2014-08-31 00:00:00', NULL, NULL, 3, 2),
(39, 'Ensure that no meter remains stuck for longer than 3 months', '2014-02-14 00:00:00', NULL, NULL, 4, 2),
(40, 'Submit an energy consumption reduction strategy by 31st January 2014 and report on implementation biannually within the tariff period.', '2014-08-31 00:00:00', NULL, NULL, 5, 2),
(41, 'Fully adhere to the 2015 Service Level Guarantees.', '2014-08-30 00:00:00', NULL, NULL, 4, 2),
(42, 'Extend service to Chandamali and Manungu Compounds Choma and Monze respectively by ', '2014-08-31 00:00:00', NULL, NULL, 4, 2),
(43, 'Ensure that actual costs do not exceed an adverse variance of 10% of the approved cost structure for 2014.', '2014-02-14 00:00:00', NULL, NULL, 4, 2),
(44, 'Maintain an average collection efficiency of at least 90% throughout the tariff period', '2014-08-31 00:00:00', NULL, NULL, 4, 2),
(45, 'Maintain an average O&M Cost coverage of at least 100% throughout the tariff period', '2014-02-14 00:00:00', NULL, NULL, 6, 2),
(46, 'Submit an energy consumption reduction strategy by 31st January 2014 and report on implementation biannually within the tariff period.', '2014-08-31 00:00:00', NULL, NULL, 6, 2),
(47, 'Submit a feasible program on how you plan to extend water supply to the following areas: Kawiku and Kaputu in Mwinilunga and Muselepete in Kasempa. Report on plan of implementation to NWASCO quarterly', '2014-08-30 00:00:00', NULL, NULL, 6, 2),
(48, 'Increase number of water connections for Solwezi, Zambezi, Kabompo districts by a total of at least 1000 by end of  August 2014', '2014-08-31 00:00:00', NULL, NULL, 6, 2),
(49, 'Ensure that external auditing of Financial Statements is up to date by end of August 2014.', '2014-02-14 00:00:00', NULL, NULL, 6, 2),
(50, 'Ring fence the fixed meter charge throughout the tariff period', '2014-08-31 00:00:00', NULL, NULL, 3, 2),
(51, 'Maintain water quality compliance  above 95%  throughout the tariff period', '2014-02-14 00:00:00', NULL, NULL, 3, 2),
(52, 'Ring fence 20% of sewerage billing throughout the tariff period', '2014-08-31 00:00:00', NULL, NULL, 3, 2),
(53, 'Ensure no meter remains stuck for longer than 3 months.', '2014-08-30 00:00:00', NULL, NULL, 7, 2),
(54, 'Maintain 100% metering ratio throughout the tariff period', '2014-08-31 00:00:00', NULL, NULL, 7, 2),
(55, 'Maintain NRW at 30% maximum during the tariff period', '2014-02-14 00:00:00', NULL, NULL, 7, 2),
(56, 'Reactivate all inactive sewer connections in Zambezi and extend to 100 new connections', '2014-08-31 00:00:00', NULL, NULL, 7, 2),
(57, 'Remain current on NWASCO license fees throughout 2014', '2014-02-14 00:00:00', NULL, NULL, 7, 2),
(58, 'Fully meet the Service level Agreement for 2014', '2014-08-31 00:00:00', NULL, NULL, 7, 2),
(59, 'Retain the 2013 tariffs on the entire Kalulushi town; Wusakile, Chamboli, Ndeke and Makobo Townships of Kitwe and Chambishi Towns respectively, until supply to the mentioned areas is improved in line with the SLG and commitment letter signed on 2nd Octobe', '2014-08-30 00:00:00', NULL, NULL, 6, 2),
(60, 'Maintain water quality compliance above 95% throughout the tariff period.', '2014-08-31 00:00:00', NULL, NULL, 6, 2),
(61, 'Maintain an average collection efficiency of at least 85% throughout the tariff period.', '2014-02-14 00:00:00', NULL, NULL, 6, 2),
(62, 'Maintain the O&M costs for the approved tariff within 10% adverse variance subject to reasonable justification.', '2014-08-31 00:00:00', NULL, NULL, 6, 2),
(63, 'Increase domestic metered connection by 5000 by August 2014.', '2014-02-14 00:00:00', NULL, NULL, 6, 2),
(64, 'Remain current on NWASCO license fees throughout 2014 and clear all accumulated licence arrears by 28th February 2014.', '2014-08-31 00:00:00', NULL, NULL, 6, 2),
(65, 'Ensure that external auditing of Financial Statements is up to date by end of August 2014.', '2014-08-30 00:00:00', NULL, NULL, 6, 2),
(66, 'Submit an energy consumption reduction strategy by 31st January 2014 and report on implementation biannually within the tariff period.', '2014-08-31 00:00:00', NULL, NULL, 6, 2),
(67, 'Ring fence the fixed meter charge and sanitation surcharge through the tariff period.', '2014-02-14 00:00:00', NULL, NULL, 6, 2),
(68, 'Ring fence 50% of the sewerage billing throughout the tariff period.', '2014-08-31 00:00:00', NULL, NULL, 6, 2),
(69, 'Ensure no meter remains stuck for longer than 3 months.', '2014-02-14 00:00:00', NULL, NULL, 6, 2),
(70, 'Fully meet the Service level Agreement for 2014.', '2014-08-31 00:00:00', NULL, NULL, 6, 2),
(71, 'Ensure that actual costs do not exceed an adverse variance of 10% of the approved cost structure for 2015 (from base K60,300,981.00 as per tariff  approval)', '2014-08-30 00:00:00', NULL, NULL, 7, 2),
(72, 'Attain an average collection efficiency of at least 85% from 67% by 31st July 2015 and maintain throughout the tariff period', '2014-08-31 00:00:00', NULL, NULL, 7, 2),
(73, 'Install 5000 meters by 31st August 2015.  ', '2014-02-14 00:00:00', NULL, NULL, 7, 2),
(74, 'Maintain water quality compliance above 95% throughout the tariff period.', '2014-08-31 00:00:00', NULL, NULL, 7, 2),
(75, 'Remain current on NWASCO license fees throughout 2015.  ', '2014-02-14 00:00:00', NULL, NULL, 7, 2),
(76, 'Ring-fence the fixed meter charge throughout the tariff period', '2014-08-31 00:00:00', NULL, NULL, 7, 2),
(77, 'Ring-fence the sanitation surcharge throughout the tariff period', '2014-08-30 00:00:00', NULL, NULL, 7, 2),
(78, 'Ring-fence 20% of the sewerage billing throughout the tariff period', '2014-08-31 00:00:00', NULL, NULL, 7, 2),
(79, 'Adhere to the  2015 Service level guarantees', '2014-02-14 00:00:00', NULL, NULL, 7, 2),
(80, 'Ensure that no meter remains stuck for longer than 3 months', '2014-08-31 00:00:00', NULL, NULL, 7, 2),
(81, 'Submit an energy consumption reduction strategy by 15th May 2015 and report on implementation biannually within the tariff period.', '2014-02-14 00:00:00', NULL, NULL, 7, 2),
(82, 'Increase total customer base by at least 2000 connections by 31st August 2015, base will be as in (2014 sector report)', '2014-08-31 00:00:00', NULL, NULL, 7, 2),
(83, 'Ensure that actual costs do not exceed an adverse variance of 10% of the approved cost structure for 2015 ( from base K26.3million as per tariff approval)', '2014-08-30 00:00:00', NULL, NULL, 4, 2),
(84, 'Attain  and maintain collection efficiency of at least 85% from 81% throughout the tariff period', '2014-08-31 00:00:00', NULL, NULL, 4, 2),
(85, 'Attain O&M cost coverage rate of at least 108%  at 85% collection efficiency by 31st October and maintain throughout the tariff period', '2014-02-14 00:00:00', NULL, NULL, 4, 2),
(86, 'Install 3,000 meters by 31st August 2015', '2014-08-31 00:00:00', NULL, NULL, 4, 2),
(87, 'Maintain water quality compliance above 95% throughout the tariff period.', '2014-02-14 00:00:00', NULL, NULL, 4, 2),
(88, 'Remain current on NWASCO license fees throughout 2015 and propose a payment plan on how licence fee arrears will be cleared within the tariff period.', '2014-08-31 00:00:00', NULL, NULL, 4, 2),
(89, 'Ring fence the fixed meter charge throughout the tariff period', '2014-08-30 00:00:00', NULL, NULL, 4, 2),
(90, 'Ring fence the sanitation charge throughout the tariff period', '2014-08-31 00:00:00', NULL, NULL, 4, 2),
(91, 'Ring fence 20% of the sewerage billing throughout the tariff period', '2014-02-14 00:00:00', NULL, NULL, 4, 2),
(92, 'Adhere to the  2015 Service level guarantees', '2014-08-31 00:00:00', NULL, NULL, 4, 2),
(93, 'Ensure that no meter remains stuck for longer than 3 months', '2014-02-14 00:00:00', NULL, NULL, 4, 2),
(94, 'Submit an energy consumption reduction strategy by 31st January 2015 and report on implementation biannually within the tariff period.', '2014-08-31 00:00:00', NULL, NULL, 4, 2),
(95, 'Increase total customer base by at least 1000 connections by 31st August 2015, base will be as in (2014 sector report)', '2014-08-30 00:00:00', NULL, NULL, 4, 2),
(96, 'Ensure that actual costs do not exceed an adverse variance of 10% of the approved cost structure of K10, 691,165 for 2015.', '2014-08-31 00:00:00', NULL, NULL, 1, 2),
(97, 'Maintain average collection efficiency above 85% throughout 2015.', '2014-02-14 00:00:00', NULL, NULL, 1, 2),
(98, 'Achieve an average O&M cost coverage by collection of 60% (from 56.8%) by August 2015.', '2014-08-31 00:00:00', NULL, NULL, 1, 2),
(99, 'Increase number of connections by 700 (from 5,350) by 30th August 2015.', '2014-02-14 00:00:00', NULL, NULL, 1, 2),
(100, 'Remain current on NWASCO license fees throughout the tariff period', '2014-08-31 00:00:00', NULL, NULL, 1, 2),
(101, 'Ensure that external auditing of Financial Statements is up to date by 31st August 2015.', '2014-08-30 00:00:00', NULL, NULL, 1, 2),
(102, 'Attend to reported leakages within 24 hours', '2014-08-31 00:00:00', NULL, NULL, 1, 2),
(103, 'Maintain water quality compliance above 95% throughout the tariff period.', '2014-02-14 00:00:00', NULL, NULL, 1, 2),
(104, 'Ensure that no meter remains stuck for longer than 3 months', '2014-08-31 00:00:00', NULL, NULL, 1, 2),
(105, 'Improve average service hours for Kawambwa from 3 to 9 hours by 30th August 2015', '2014-02-14 00:00:00', NULL, NULL, 1, 2),
(106, 'Maintain 100% metering throughout the tariff period', '2014-08-31 00:00:00', NULL, NULL, 1, 2),
(107, 'Fully adhere to the 2015 Service Level Guarantees', '2014-08-30 00:00:00', NULL, NULL, 1, 2),
(108, 'Improve service hours in Chabanyama, Lulamba and Twatasha in Chingola to the SLG by April 2014', '2014-08-31 00:00:00', NULL, NULL, 5, 2),
(109, 'Maintain an average collection efficiency of at least 90% throughout the tariff period', '2014-02-14 00:00:00', NULL, NULL, 5, 2),
(110, 'Maintain full cost coverage rate of at least 100% at current collection efficiency throughout the tariff period', '2014-08-31 00:00:00', NULL, NULL, 5, 2),
(111, 'Ensure no meter remains stuck for longer than 3 months', '2014-02-14 00:00:00', NULL, NULL, 5, 2),
(112, 'Increase number of water and sewer connections by 2,000 and 1,000 respectively by 31st August 2014', '2014-08-31 00:00:00', NULL, NULL, 5, 2),
(113, 'Achieve 100% metering for bulk meters and 80% customer meters by 30th June 2014', '2014-08-30 00:00:00', NULL, NULL, 5, 2),
(114, 'Submit an energy consumption reduction strategy by 31st January 2014 and report on implementation biannually within the tariff period', '2014-08-31 00:00:00', NULL, NULL, 5, 2),
(115, 'Remain current on NWASCO license fees throughout the tariff period', '2014-02-14 00:00:00', NULL, NULL, 5, 2),
(116, 'Improve water quality compliance  to 95%  by August  2014', '2014-08-31 00:00:00', NULL, NULL, 5, 2),
(117, 'Ensure that external auditing of Financial Statements is up to date by end of August 2014', '2014-02-14 00:00:00', NULL, NULL, 5, 2),
(118, 'Ring fence 50% of the sewerage billing throughout the tariff period', '2014-08-31 00:00:00', NULL, NULL, 5, 2),
(119, 'Ring fence the fixed meter charge and the sanitation surcharge  throughout the tariff period', '2014-08-30 00:00:00', NULL, NULL, 5, 2);
...
--
-- Table structure for table `sslas`
--

CREATE TABLE IF NOT EXISTS `sslas` (
  `slas_id` double DEFAULT NULL,
...
--
-- Dumping data for table `sslas`
--

INSERT INTO `sslas` (`slas_id`, `agreement`, `due_date`, `status`, `remarks`, `ps_id`, `sin_id`) VALUES
(1, 'Ensure that actual costs do not exceed an adverse variance of 10% of the approved cost structure for 2014.', '2014-02-14 00:00:00', NULL, NULL, 1, 3),
(2, 'Maintain an average collection efficiency of at least 85% throughout the tariff period', '2014-08-31 00:00:00', NULL, NULL, 1, 3),
(3, 'Maintain a full  cost coverage rate of at least 90%  at 85% collection efficiency throughout the tariff period', '2014-02-14 00:00:00', NULL, NULL, 1, 3),
(4, 'Reactivate 900 customer accounts by 31st August 2014', '2014-08-31 00:00:00', NULL, NULL, 1, 3),
(5, 'Increase number of connections by at least 500 by 30th August 2014', '2014-08-30 00:00:00', NULL, NULL, 2, 3),
(6, 'Improve metering to at least 85% by 31st August 2013', '2014-08-31 00:00:00', NULL, NULL, 2, 3),
(7, 'Maintain water quality compliance above 95% throughout the tariff period.', '2014-02-14 00:00:00', NULL, NULL, 2, 3),
(8, 'Remain current on NWASCO license fees throughout 2014 and propose a payment plan on how your licence fee arrears will be cleared within the tariff period.', '2014-08-31 00:00:00', NULL, NULL, 3, 3),
(9, 'Ring fence the fixed meter charge throughout the tariff period', '2014-02-14 00:00:00', NULL, NULL, 3, 3),
(10, 'Fully meet the  2014 Service level agreement', '2014-08-31 00:00:00', NULL, NULL, 3, 3),
(11, 'Ensure that external auditing of Financial Statements is up to date.', '2014-08-30 00:00:00', NULL, NULL, 4, 3),
(12, 'Ensure that no meter remains stuck for longer than 3 months', '2014-08-31 00:00:00', NULL, NULL, 5, 3),
(13, 'Submit an energy consumption reduction strategy by 14th February 2014 2014 and report on implementation biannually within the tariff period.', '2014-02-14 00:00:00', NULL, NULL, 4, 3),
(14, 'Ensure that actual costs do not exceed an adverse variance of 10% of the approved cost structure of  K22,548,540 for 2015', '2014-08-31 00:00:00', NULL, NULL, 4, 3),
(15, 'Achieve an average collection efficiency of at least 85% by 31st August 2015', '2014-02-14 00:00:00', NULL, NULL, 4, 3),
(16, 'Achieve O&M cost coverage rate of at least 68% at 85% collection efficiency by 31st August 2015', '2014-08-31 00:00:00', NULL, NULL, 4, 3),
(17, 'Increase number of connections by  900 from the current 15,266  by 31st August 2015', '2014-08-30 00:00:00', NULL, NULL, 6, 3),
(18, 'Maintain 100% metering throughout the tariff period', '2014-08-31 00:00:00', NULL, NULL, 6, 3),
(19, 'Maintain water quality compliance above 95% throughout the tariff period', '2014-02-14 00:00:00', NULL, NULL, 6, 3),
(20, 'Remain current on NWASCO license fees throughout 2015 and propose a payment plan on how 40% of your licence fee arrears (base K275,860) will be cleared within the tariff period i.e. January to August 2015. ', '2014-08-31 00:00:00', NULL, NULL, 6, 3),
(21, 'Ring fence the fixed meter charge throughout the tariff period', '2014-02-14 00:00:00', NULL, NULL, 6, 3),
(22, 'Fully adhere to the  2015 Service Level Guarantees', '2014-08-31 00:00:00', NULL, NULL, 7, 3),
(23, 'Ensure that external auditing of Financial Statements is up to date', '2014-08-30 00:00:00', NULL, NULL, 7, 3),
(24, 'Ensure that no meter remains stuck for longer than 3 months', '2014-08-31 00:00:00', NULL, NULL, 7, 3),
(25, 'Submit a plan on how you intend to extend water supply service to the Mental Hospital in Chadiza and Airport  and Farmers training college in Mambwe by 28th February 2015', '2014-02-14 00:00:00', NULL, NULL, 7, 3),
(26, 'Submit a plan on how you intend to improve sewerage services in Kapata in Chipata by 28th February 2015', '2014-08-31 00:00:00', NULL, NULL, 7, 3),
(27, 'Submit an energy consumption reduction strategy by 31st January 2015 and report on implementation biannually within the tariff period', '2014-02-14 00:00:00', NULL, NULL, 7, 3),
(28, 'Ring fence 20% of the sewerage billing throughout the tariff period', '2014-08-31 00:00:00', NULL, NULL, 7, 3),
(29, 'Ensure that actual costs do not exceed an adverse variance of 10% of the approved cost structure (ZMW50, 750,739) for 2015.', '2014-08-30 00:00:00', NULL, NULL, 1, 3),
(30, 'Maintain an average collection efficiency of at least 85% throughout the tariff period', '2014-08-31 00:00:00', NULL, NULL, 1, 3),
(31, 'Achieve an O&M cost coverage rate of at least 116%  at 85% collection efficiency by August 2015', '2014-02-14 00:00:00', NULL, NULL, 1, 3),
(32, 'Increase total customer base by at least 2,400 connections by 31st August 2015 from the current 40,965 total connections.', '2014-08-31 00:00:00', NULL, NULL, 1, 3),
(33, 'Install 4,000 meters by 31st August 2015. ', '2014-02-14 00:00:00', NULL, NULL, 2, 3),
(34, 'Maintain water quality compliance above 95% throughout the tariff period.', '2014-08-31 00:00:00', NULL, NULL, 2, 3),
(35, 'Remain current on NWASCO license fees throughout 2015', '2014-08-30 00:00:00', NULL, NULL, 2, 3),
(36, 'Ring fence the fixed meter charge throughout the tariff period', '2014-08-31 00:00:00', NULL, NULL, 3, 3),
(37, 'Ring fence 20% of the sewerage billing throughout the tariff period', '2014-02-14 00:00:00', NULL, NULL, 3, 3),
(38, 'Ensure that external auditing of Financial Statements is up to date.', '2014-08-31 00:00:00', NULL, NULL, 3, 3),
(39, 'Ensure that no meter remains stuck for longer than 3 months', '2014-02-14 00:00:00', NULL, NULL, 4, 3),
(40, 'Submit an energy consumption reduction strategy by 31st January 2014 and report on implementation biannually within the tariff period.', '2014-08-31 00:00:00', NULL, NULL, 5, 3),
(41, 'Fully adhere to the 2015 Service Level Guarantees.', '2014-08-30 00:00:00', NULL, NULL, 4, 3),
(42, 'Extend service to Chandamali and Manungu Compounds Choma and Monze respectively by ', '2014-08-31 00:00:00', NULL, NULL, 4, 3),
(43, 'Ensure that actual costs do not exceed an adverse variance of 10% of the approved cost structure for 2014.', '2014-02-14 00:00:00', NULL, NULL, 4, 3),
(44, 'Maintain an average collection efficiency of at least 90% throughout the tariff period', '2014-08-31 00:00:00', NULL, NULL, 4, 3),
(45, 'Maintain an average O&M Cost coverage of at least 100% throughout the tariff period', '2014-02-14 00:00:00', NULL, NULL, 6, 3),
(46, 'Submit an energy consumption reduction strategy by 31st January 2014 and report on implementation biannually within the tariff period.', '2014-08-31 00:00:00', NULL, NULL, 6, 3);
...
(1, '127.0.0.1', 'trudy', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'admin@admin.com', '', NULL, NULL, 'pEzxKZ5IDdQyPf30AkuuM.', 1268889823, 1473569483, 1, 'Admin', 'istrator', 'ADMIN', '0'),
